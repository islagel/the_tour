...
```{r, echo = FALSE}
inputPanel(
  selectInput("b", label = "Countries:", c(tour_data$Country[!is.na(tour_data$Country)]), multiple = TRUE),
...
```{r , echo=FALSE}
inputPanel(selectInput("b", label = h6("Countries:"), c(tour_data$Country[!is.na(tour_data$Country)]), multiple = TRUE, selected = c("United States", "France")),checkboxInput("doped2", label = h6("Exclude Doped Winners"), FALSE)
)
```
...
=======
>>>>>>> 291b6dd4a223cbcd11a83f42bfed412f0770cc3b
```
