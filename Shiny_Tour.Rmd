...
inputPanel(
  checkboxGroupInput("x", label = "Fill variable:",
    choices = c("Stripped of Title" = "Stripped of title in the current race due to doping.",
    ...
    selected = "Has never been: stripped of a title, failed tests or sanctioned for doping to date, with no known accusations.")
)
