...
In general we are better set to answer the questions mentioned in the original preliminary report. 
...
Well. We have scraped all data and plan to have relevant data merged before class on Tuesday. 
